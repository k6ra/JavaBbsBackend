...
public class UserRepositoryTest {
    ...
    public void testFind() {
        ...
        List<UserModel> findUser = userRepository.find(1);
    ...
    public void testEntry() {
        ...
        userRepository.entry(entryUser);

        List<UserModel> findUser = userRepository.find(entryUser.getId());
    ...
    public void testUpdate() {
        ...
        List<UserModel> findUser = userRepository.find(updateUser.getId());
    ...
    public void testDelete() {
        ...
        List<UserModel> findUser = userRepository.find(deleteUser.getId());
